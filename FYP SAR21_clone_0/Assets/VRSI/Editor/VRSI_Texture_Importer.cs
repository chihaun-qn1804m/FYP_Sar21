...
public class VRSI_Texture_Importer : AssetPostprocessor
{
    ...
    {
        VRSI_RenderTool daBoss = Object.FindObjectOfType<VRSI_RenderTool>();

        if (daBoss != null)
        {

            if (daBoss.AllowPostProcess)
            {
    ...
    void OnPostprocessTexture(Texture2D texture)
    {
        ...
        if (daBoss != null)
        {
            if (daBoss.AllowPostProcess)
            {
                ...
                //===============================================
                //Test this stops infinite import loop bug

                if (Application.isPlaying)
                {
                    daBoss.AllowPostProcess = false;
                }
                //==============================================
